# Trainer’s guide to Tracker Data Capture & Analysis Fundamentals (Web-Based)
...
In this demo, the **Electronic Immunization Registry and Malaria Case Notification,Investigation and Response** demo programs that have been created will be used to demonstrate the features of tracker capture.
...
Go over the Electronic Immunization Registry used in this tracker program to demonstrate the participants the data capture for a program with repeatable stages.

1. Open **Tracker Capture** and navigate to CH Mahosot. Select the Electronic Immunization Regitry as the tracker program.
...
3. **Register a TEI** : You can start with a duplicate record that already exists (Lisa) in order to show the process of identifying duplicates. In this case, since she already exists there is no need to register her. You can go to her tracker dashboard instead to review her completed events.
...
10. Complete the event and the system will schedule another event for the next vaccine dose.The system will generate a second dose vaccine dose date depending upon the selection of vaccine.
...
![image15.png](resources/images/tracker_capture_web/new1.png "image_tooltip")


The **''Electronic Immunization Registry''** is linked to any Organization Unit at the health facility level and above. CH Mahosot has some example cases already entered. Click on the ‘+’ symbol to expand the hierarchy in the desired branch. For example, to find “CH Mahosot”, expand Lao PDR, then 01 Vientiane Capital, then 0101 Chanthabouli and finally CH Mahosot.Click on the site name to select it. When selected the org unit’s name will change color to orange.

3. Select a Program

Only programs relevant (allocated) to the selected org unit and user will show up in the Program drop down list. If the Electronic Immunization Registry is not already selected, make sure to select it from the program list under the “Tracker Capture” heading. 

![image15.png](resources/images/tracker_capture_web/new2.png "image_tooltip")

You will see the list below which is coming through the attribute display list option.

![image19.png](resources/images/tracker_capture_web/new3.png "image_tooltip")

**After you have explained the interface options, proceed to register a TEI into the program.**

### Part 2 : Registration

**Register a TEI into the Electronic Immunization program:** During registration, it is possible to stay on the same page and keep registering more than one entity. You can also go straight to the dashboard of the registered TEI. Selecting a program and doing registration also performs enrollment into the program at the background. If a TEI is registered without a program, then enrollment is possible from the TEI dashboard. Both skip-logic and validation error/warning messages are supported during registration.
...
System generated ID’s can follow patterns that are defined by the user. This example uses the “EPI - Random number”
...
In later sessions, you will go over the terminology in more detail so just focus on describing the interface and actions for now. Enter a TEI that already exists (***Maria***) in the system. You will be notified that a possible duplicate has already been found.


![image32.png](resources/images/tracker_capture_web/new4.png "image_tooltip")
...
![image8.png](resources/images/tracker_capture_web/new5.png "image_tooltip")
...
![image13.png](resources/images/tracker_capture_web/new6.png "image_tooltip")
...
Discussion on how to do registration and enrollment using capture app is being discussed in Capture app session.

**STOP - Perform Exercise 1**   
   
### Part 3 : Describe the Tracker Dashboard

![image19.png](resources/images/tracker_capture_web/new7.png "image_tooltip")
...
![](resources/images/tracker_capture_web/new8.png)
...
![](resources/images/tracker_capture_web/new9.png)
...
8. **Relationship** - This helps to relate the selected TEI (the one whose dashboard is shown) to another TEI. Adding a relative is possible by either searching from existing or registering a new one. If a program is selected while registering a new one, the new one will be automatically enrolled to the selected program. Another interesting feature in the relationship widget is attribute inheritance. For example having a contact relationship within the Contact tracing program,the affected patient need to add a relationship with a person with a current patient that has been registered in a case based surveillance program. If among others first name, last name and address attributes are required for both Programs.
...
![](resources/images/tracker_capture_web/new10.png)

A prompt will ask you if you are sure you want to complete the event.

![](resources/images/tracker_capture_web/new11.png)
...
![](resources/images/tracker_capture_web/new12.png.png)
...
![](resources/images/tracker_capture_web/new13.png)
...
![](resources/images/tracker_capture_web/new14.png)
...
![](resources/images/tracker_capture_web/new17.png)

You can select the program and use search to filter TEI’s. You may have, for example, a contact relationship with Immunization cases.

![](resources/images/tracker_capture_web/new18.png)

Select the TEI. It will bring up their details. Click on “Save” to save the relationship.

![](resources/images/tracker_capture_web/new19.png)
...
![](resources/images/tracker_capture_web/new20.png)


#### Make a Referral

![](resources/images/tracker_capture_web/new21.png)
...
![](resources/images/tracker_capture_web/new22.png)

#### Register a TEI with no Program

* A TEI can also be registered without selecting a program. De-select the Electronic Immunization program so that the program selection field is blank. Select the person TEI type and click on “Register". Enter the details and Select “Save and continue".

![](resources/images/tracker_capture_web/new23.png)
...
* Select the Electronic Immunization registry program  and click on “Add new.” The attributes for the program will appear. You can fill them out to register the person into the  program. Using the program selector, TEI’s can be registered in multiple programs directly from the dashboard. 

![image5.png](resources/images/tracker_capture_web/new24.png "image_tooltip")
