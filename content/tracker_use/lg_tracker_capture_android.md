...
This guide contains all exercises and detailed steps to perform them related to the Level 1 - Tracker Data Capture and Analysis Academy. Please perform each of the exercises when prompted to by your instructors
...
You will see all the events associated with the case within the case-base surveillance program, starting with the most recent event in each program stage. 
 ...
 There are 4 tabs at the bottom when you open the record. 
