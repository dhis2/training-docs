...
Each of these components will require a companion piece of material to assist the instructor in explaining the concept as well as the learning in performing and retaining the concept. If you are not familiar with this process, then it is a good time to re-visit the types of material you will for each session in order to ensure each component within your learning framework for a particular session will be met.
