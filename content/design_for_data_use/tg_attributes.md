# Trainer’s Guide to the Attrbute Model
...
3. Configure attribute options, attributes, attribute combos in maintenance
4. Verify the creation of attribute option combos via the API
...
### Create a chart using attribute option combos

#### STOP - Perform Exercise 1

### Review a data set using attributes

#### STOP - Perform Exercise 2

### Show how to create attribute options, attributes and attribute combos in the maintenance app

#### STOP - Perform Exercise 3

### Check the creation of attribute option combos Via the API
